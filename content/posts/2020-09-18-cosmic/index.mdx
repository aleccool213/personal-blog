...
description: Cosmic CMS is a great choice when creating a blog, band website or e-commerce store
tags:
  - Next.js
  - React
  - GraphQL
...
<strong style="margin: 0 auto 35px;">
  Want to follow along with the build?{" "}
  <a href="https://www.cosmicjs.com/apps/nextjs-static-blog" target="_blank">
    Click here to grab the app or fork the project.
  </a>
</strong>
...
<div class="Image__Medium">
  <img
    src="https://res.cloudinary.com/dscgr6mcw/image/upload/v1600443356/next-js-cosmic-post/CleanShot_2020-09-18_at_10.15.26_2x.png"
    alt="Screenshot of the Cosmic CMS Dashboard"
  />
