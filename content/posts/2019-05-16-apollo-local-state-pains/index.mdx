---
title: Wrestling with Apollo Local State and winning
banner: ./images/photo1.jpg
date: 2019-05-16
description: Recently we bought into GraphQL and use it in every one of our web apps, both on the client and server level.
