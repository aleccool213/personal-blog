...
![](https://res.cloudinary.com/dscgr6mcw/image/upload/v1601385465/docker-sql-post/entire_service_diagram.png)

Our service diagram

My goal is to start the entire set of services in a deterministic manner, have each service wait until its dependent service is running and healthy. I'll focus on the database and migrations in this post but the concepts here extend to any service having dependancies on another service.
