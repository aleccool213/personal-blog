...
description: The things that make Fish great, the caveats and which (few) plugins you need to complete the experience.
...
<div class="Image__Medium">
  <img
    src="https://res.cloudinary.com/dscgr6mcw/image/upload/v1565392191/fish-post/giphy_1.gif"
    alt="bart simpson dancing"
  />
...
<div class="Image__Small">
  <img
    src="https://res.cloudinary.com/dscgr6mcw/image/upload/v1565391692/fish-post/spacefish_example.png"
    alt="spacefish-shell-prompt-example"
  />
